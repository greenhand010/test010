...
download_azurlane () {
    ...
    url="https://downali.game.uc.cn/s1/2/10/20230213150150_blhx_uc_2022_11_02_18_24_01.apk?x-oss-process=udf/uc-apk,ZBHDhDR0LVBkTsK*wpLCng==afae37c2a88fd1ca&sh=10&sf=1831727323&vh=18330f93bd450707942ce0b882a0c6b2&cc=2521889677&did=502cbdf87231422c9ebeed11c99d5246"
    # 使用wget命令下载apk文件
    curl -o blhx.apk  $url
    fi
}
